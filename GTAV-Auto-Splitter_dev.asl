...
startup
{
	...
	vars.cutsceneNames = new Dictionary<string,string> {
		...
		{"armenian_2_int", "Start Reposession"},
		{"arm_2_mcs_4", "Reposession: Confronted by Vagos"},
		{"tonya_mcs_1", "Start Pulling Favors"},
		{"fra_0_int", "Start Chop"},
		{"fra_0_mcs_1", "Chop: Confront D in Alley"},
		{"fra_0_mcs_4_p2_t3", "Chop: Put D in Van"},
		{"armenian_3_int", "Start Complications"},
		...
		{"lester_1_int", "Start Friend Request"},
		...
		{"jh_1_ig_3", "Casing the Jewel Store: Greet Employee"},
		{"jh2_fina_mcs4_a1a2", "Jewel Store Job: Leave Jewel Store"},
		{"lamar_1_int", "Start The Long Stretch"},
		{"lam_1_mcs_1_concat", "The Long Stretch: Meet D"},
		{"trv_1_mcs_1_p1", "Mr. Phillips: Finish First Drive"},
		{"trv_1_mcs_3_concat", "Mr. Phillips: Smash Trailer"},
		{"chinese_1_int", "Start TPI"},
		{"trevor_2_int", "Start Nervous Ron"},
		{"trv_2_mcs_4_concat", "Nervous Ron: Shoot Down Chopper"},
		{"trv_2_mcs_6", "Nervous Ron: Board Plane"},
		{"chinese_2_int", "Start Crystal Maze"},
		{"chi_2_mcs_5", "Crystal Maze: Arrive at Farmhouse"},
		{"trevor_drive_int", "Start Friends Reunited"},
		{"trv_dri_mcs_concat", "Friends Reunited: Look over Los Santos"},
		{"family_4_mcs_2", "Fame or Shame: Enter Arena"},
		{"fbi_1_int", "Start Dead Man Walking"},
		{"family_5_mcs_1", "Yoga: Finish 1st Pose"},
		{"family_5_mcs_2", "Yoga: Finish 2nd Pose"},
		{"family_5_mcs_3", "Yoga: Finish 3rd Pose"},
		{"family_5_mcs_4", "Yoga: Meet Jimmy"},
		...
		{"lsdh_int", "Start Scouting the Port"},
		{"lsdh_mcs_2", "Scouting the Port: Arrive at Security Gate"},
		{"franklin_1_int", "Start Hood Safari"},
		{"fra_1_mcs_1", "Hood Safari: The Deal"},
		{"dhp1_mcs_1", "Minisub: Getting Pulled out of the Water"},
		{"fbi_3_int", "Start By the Book"},
		{"fbi_3_mcs_1", "By the Book: Finish Interrogation 1"},
		{"fbi_3_mcs_2", "By the Book: Arrive at house"},
		{"fbi_3_mcs_7", "By the Book: Finish the Assassination"},
		{"ass_int_2_alt1", "Start Hotel Assassination"},
		{"lsdh_2a_int", "Start Merryweather Heist"},
		...
		{"martin_1_mcs_1", "Caida Libre: Get Files"},
		{"exl_1_mcs_1_p3_b", "Minor Turbulence: Enter Cargo Jet"},
		{"rbhs_mcs_1", "Paleto Score Setup: Enter Paleto Bay"},
		{"rbh_2a_mcs_2_p7", "Paleto Score: Confront Cops"},
		{"rbh_2ab_mcs_6", "Paleto Score: Forced into Alley"},
		{"rbh_2a_mcs_4", "Paleto Score: Franklin Meets Michael"},
		{"fbi_5_int", "Start Monkey Business"},
		{"fbi_5a_mcs_1", "Monkey Business: Leave Water"},
		{"fbi_5b_mcs_1", "Monkey Business: Pick up Container"},
		{"fbi_5a_mcs_10", "Monkey Business: Leave Helicopter"},
		{"trv_5_int", "Start Hang Ten"},
		{"mic_1_int", "Start Bury the Hatchet"},
		{"car_5_mcs_1", "Pack Man: Start Packer Drive"},
		{"fam_6_mcs_1", "Reuniting the Family: Confront Amanda"},
		{"fam_6_mcs_2_concat", "Reuniting the Family: Enter Tatoo Shop"},
		{"fam_6_mcs_3", "Reuniting the Family: Finish Piercings"},
		{"fam_6_mcs_4", "Reuniting the Family: Finish Tattoo"},
		{"fam_6_mcs_5", "Reuniting the Family: Cut Hair"},
		{"fam_6_mcs_6", "Reuniting the Family: Arrive at Therapy"},
		...
		{"mic_3_int", "The Wrap Up: Meet Dave"},
		{"bs_2a_mcs_1", "Big Score Subtle: Hijack security trucks"},
		{"bs_2a_mcs_8_p3", "Big Score Subtle: Finish shootout"},
		{"bs_2a_mcs_11", "Big Score Subtle: Finish Drive Sequence"},
