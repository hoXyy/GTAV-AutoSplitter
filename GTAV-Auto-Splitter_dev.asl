...
startup
{
	...
	vars.cutsceneNames = new Dictionary<string,string> {
		...
		{"tonya_mcs_1", "Begin Pulling Favors"},
		{"fra_0_int", "Chop: Initial Cutscene"},
		{"fra_0_mcs_1", "Confront D in Alley"},
		{"fra_0_mcs_4_p2_t3", "Put D in Van"},
		{"armenian_3_int", "Complications: Initial Cutscene"},
		...
		{"jh2_fina_mcs4_a1a2", "Leave Jewel Store (heist)"},
		{"lamar_1_int", "Begin Long Stretch"},
		...
		{"chinese_1_int", "Begin TPI"},
		{"trevor_2_int", "Begin Nervous Ron"},
		{"trv_2_mcs_4_concat", "Nervous Ron: Shoot Down Chopper"},
		{"trv_2_mcs_6", "Nervous Ron: Board Plane"},
		{"chinese_2_int", "Begin Crystal Maze"},
		{"chi_2_mcs_5", "Arrive at Farmhouse"},
		{"trevor_drive_int", "Begin Friends Reunited"},
		{"trv_dri_mcs_concat", "Look over Los Santos"},
		{"family_4_mcs_2", "Fame or Shame: Enter Arena"},
		{"fbi_1_int", "Start Dead Man Walking"},
		{"family_5_mcs_1", "Finish first pose"},
		{"family_5_mcs_2", "Finish 2nd pose"},
		{"family_5_mcs_3", "Finish Yoga"},
		{"family_5_mcs_4", "Meet Jimmy"},
		{"family_5_mcs_5", "Greet Drug Dealer"},
		{"fam_5_mcs_6", "Hallucination Sequence"},
		{"fbi_2_int", "Start Three's Company"},
		{"fbi_2_mcs_1", "Enter Trevor"},
		{"fbi_2_mcs_2", "Start Rapelling"},
		{"fbi_2_mcs_3_p1a", "Break Glass"},
		{"fbi_2_mcs_3b", "Finish Building Shootout"},
		{"lsdh_int", "Begin Scouting the Port"},
		{"lsdh_mcs_2", "Arrive at Security Gate"},
		{"franklin_1_int", "Start Hood Safari"},
		{"fra_1_mcs_1", "The Deal"},
		{"dhp1_mcs_1", "Minisub gets on land"},
		{"fbi_3_int", "Start By the Book"},
		{"fbi_3_mcs_1", "By the Book: Finish Interrogation 1"},
		{"fbi_3_mcs_2", "Arrive at house"},
		{"fbi_3_mcs_7", "Finish the Assassination"},
